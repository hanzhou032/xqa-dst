...
class InputFeatures(object):
    ...
    def __init__(self,
        ...
        self.input_ids_no_slot = input_ids_no_slot
        self.input_mask_no_slot = input_mask_no_slot
        self.segment_ids_no_slot = segment_ids_no_slot
...
def convert_examples_to_features(examples, slot_list, class_types, model_type, tokenizer, max_seq_length,
    ...
    def _get_transformer_input(tokens_a, tokens_b, history, tokens_slot, max_seq_length, tokenizer, model_specs, no_slot=False):
    ...
    for (example_index, example) in enumerate(examples):
        ...
        segment_ids_dict = {}
        tokens_dict_no_slot = {}
        input_ids_dict_no_slot = {}
        input_mask_dict_no_slot = {}
        segment_ids_dict_no_slot = {}
        value_dict = {}
        inform_dict = {}
        inform_slot_dict = {}
        refer_id_dict = {}
        ...
        for slot in slot_list:
            ...
            tokens_no_slot, input_ids_no_slot, input_mask_no_slot, segment_ids_no_slot = _get_transformer_input(tokens_a,
                                                                                tokens_b,
                                                                                tokens_history,
                                                                                tokens_slot,
                                                                                max_seq_length,
            ...
            tokens_dict_no_slot[slot] = tokens_no_slot
            input_ids_dict_no_slot[slot] = input_ids_no_slot
            input_mask_dict_no_slot[slot] = input_mask_no_slot
            segment_ids_dict_no_slot[slot] = segment_ids_no_slot
        ...
        if example_index < 0:
            ...
            logger.info("input_ids_no_slot: %s" % str(input_ids_dict_no_slot))
            logger.info("input_mask_no_slot: %s" % str(input_mask_dict_no_slot))
            logger.info("segment_ids_no_slot: %s" % str(segment_ids_dict_no_slot))
            ...
            if not evaluate:
                ...
                features.append(
                    InputFeatures(
                        ...
                        input_mask=input_mask_dict[slot],
                        segment_ids=segment_ids_dict[slot],
                        input_ids_no_slot=input_ids_dict_no_slot[slot],
                        input_mask_no_slot=input_mask_dict_no_slot[slot],
                        segment_ids_no_slot=segment_ids_dict_no_slot[slot],
                        start_pos=start_pos_dict[slot],
                        end_pos=end_pos_dict[slot],
                        values=value_dict[slot],
                        inform=inform_dict[slot],
