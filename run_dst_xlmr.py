...
from utils_dst_domain_filter_woz2 import (convert_examples_to_features)
...
def evaluate(args, model, tokenizer, processor, translator, prefix=""):
    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        with torch.no_grad():
            ...
            if count != 0 and not domain_slot_flag[0]:
...
def main():
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for cItr, checkpoint in enumerate(checkpoints):
            ...
            # Evaluate
            result = evaluate(args, model, tokenizer, processor, translator, prefix=global_step)
