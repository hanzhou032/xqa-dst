        ...
        for pred in preds:
            ...
            if joint_gt_slot == joint_pd_slot:
                ...
                if no_match:
                    ...
                    total_correct = False
                    print("  [%s] Incorrect value (variant), ground truth: %s (turn class: %s) | prediction: %s (turn class: %s)" % (
...
if __name__ == "__main__":
    ...
    if dataset not in ['woz2', 'sim-m', 'sim-r', 'multiwoz21', 'multiwoz21_zh']:
